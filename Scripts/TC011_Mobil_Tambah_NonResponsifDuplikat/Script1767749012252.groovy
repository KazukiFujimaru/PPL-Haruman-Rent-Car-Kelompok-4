...
WebUI.setText(findTestObject('Object Repository/02_Mobil/Modal Tambah/input_Merk Mobil_merk_mobil'), 'Duplikat')

WebUI.setText(findTestObject('Object Repository/02_Mobil/Modal Tambah/input_Type Mobil_tipe_mobil'), 'Duplikat')
...
WebUI.verifyTextNotPresent('Duplikat', false)

WebUI.click(findTestObject('Object Repository/02_Mobil/Modal Tambah/button_Tambah Data'))

WebUI.verifyElementPresent(findTestObject('02_Mobil/Modal Tambah/div_Tambah Data Mobil'), 0, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/02_Mobil/Modal Tambah/input_Plat Nomor_plat_nomor'), 'Z 1234 DAV', FailureHandling.CONTINUE_ON_FAILURE)
