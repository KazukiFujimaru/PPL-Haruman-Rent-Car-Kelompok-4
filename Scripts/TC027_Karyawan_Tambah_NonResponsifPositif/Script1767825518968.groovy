...
WebUI.verifyElementVisible(findTestObject('03_Karyawan/Modal Tambah/div_ID Karyawan                            _5aeb07'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('03_Karyawan/Modal Tambah/div_Tambah Data Karyawan'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('Object Repository/03_Karyawan/Modal Tambah/input_ID Karyawan_id_cs'), 'CS004', FailureHandling.CONTINUE_ON_FAILURE)
