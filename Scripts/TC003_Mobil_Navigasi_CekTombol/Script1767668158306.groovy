...
WebUI.click(findTestObject('Object Repository/02_Mobil/Halaman Utama/a_Menu Rental'))

WebUI.click(findTestObject('Object Repository/02_Mobil/Halaman Utama/a_Daftar Mobil'))
...
WebUI.verifyElementAttributeValue(findTestObject('02_Mobil/Halaman Utama/button_Cetak Data'), 'onClick', 'window.print();', 
    0)
