...
WebUI.setText(findTestObject('Object Repository/02_Mobil/Modal Tambah/input_Plat Nomor_plat_nomor'), 'Z 5678 DAV')
...
WebUI.setText(findTestObject('Object Repository/02_Mobil/Modal Tambah/input_Type Mobil_tipe_mobil'), 'Lancer V6')

WebUI.click(findTestObject('Object Repository/02_Mobil/Modal Tambah/input_Hapus_tambah'))

WebUI.verifyElementPresent(findTestObject('02_Mobil/Modal Tambah/div_Tambah Data Mobil'), 0)

WebUI.setText(findTestObject('Object Repository/02_Mobil/Modal Tambah/input_Tahun di Buat_thn_buat'), '2021')
...
WebUI.verifyTextPresent('Z 5678 DAV', false)
